...
Common labels
*/}}
{{- define "memory-chart.labels" -}}
helm.sh/chart: {{ include "memory-chart.chart" . }}
{{ include "memory-chart.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "memory-chart.selectorLabels" -}}
app.kubernetes.io/name: {{ include "memory-chart.name" . }}
...
*/}}
{{- define "memory-chart.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "memory-chart.fullname" .) .Values.serviceAccount.name }}
{{- else }}
...
*/}}
{{- define "memory-chart.imagePullSecrets" -}}
{{- $global := .Values.global | default dict -}}
